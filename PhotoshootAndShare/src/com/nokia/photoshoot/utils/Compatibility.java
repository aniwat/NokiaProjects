...
public final class Compatibility {
   ...
   * @return Command
   */
  public static Command getCommand(String label, int type, int priority, int icon) {
    try {
   ...
   * @return Command
   */
  public static Command getCommand(Image selected, Image unselected, String label, int type, int priority) {
    try {
      Class.forName("com.nokia.mid.ui.IconCommand"); //Try to produce the exception
      Object c = new IconCommand(label, selected, unselected, type, priority);
      return (Command) c;
    } catch (ClassNotFoundException e) {
      Command c = new Command(label, type, priority);
      return c;
